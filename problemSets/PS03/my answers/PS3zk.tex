...
The equation used to estimate the response variable's probability in log-odds form is: 
...
\vspace{0.1cm}
	\lstinputlisting[language=R, firstline=51,lastline=57]{PS3ZK.R}
\vspace{0.5cm}
...
\begin{table}[!htbp] \centering 
	...
	\begin{tabular}{@{\extracolsep{5pt}} ccccc} 
		...
		& (Intercept) & REG & OIL & .1 \\ 
		\hline \\[-1.8ex] 
		Negative & $44.942$ & $3.972$ & $119.578$ & $26.439$ \\ 
		Positive & $93.108$ & $5.865$ & $97.156$ & $0.880$ \\ 
		\hline \\[-1.8ex] 
	\end{tabular} 
\end{table} 
\vspace{0.5cm}
\begin{description}
	\item
	\noindent Reg Negative - On average, holding all else constant, a change from a non-democracy to a democracy is associated with a 1.379 log-odds change when going from no change to a negative change in Difference in GDP.
...
Oil Negative - On average, holding all else constant, going to a country with the average ratio of fuel exports to total exports greater than 50\% is associated with an increase of 4.784 in log odds when going from no change to a negative change in the difference in GDP.
...
\begin{table}[!htbp] \centering 
	...
	\end{tabular} 
\end{table} 
Reg: Holding other variables constant, on average, for democracies, the log  odds of having a positive Difference in GDP increases by about 0.410.

OIL: Holding other variables constant, on average, for countries with the ratio of fuel expoets to total export exceeding 50\%, the log  odds of having a positive Difference in GDP decreases by about 0.179.
